...
class AddProductAdmin extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <NavigationBar />
                <div style={{ backgroundImage: 'linear-gradient(to bottom, #f0b35f, #f2bd75, #f3c68a, #f4d09f, #f5d9b5, #fcddc4, #ffe3d4, #ffe9e2, #ffeeee, #fef4f8, #fdfafd, #ffffff)'}}>
                    ...
                    <div className="d-flex flex-wrap  bd-highlight mb-3 justify-content-center">
                        ...
                        <div style={styles.contDesc}>
                            <Form>
                                ...
                                <Button style={{ marginTop: '2%', marginBottom: '2%' }} onClick={this.confirmAddProd}>Add Product</Button>
                            </Form>
                        </div>
                    </div>
...
export default connect(mapStateToProps, { keepAdminLogin })(AddProductAdmin);
