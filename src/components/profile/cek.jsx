                ...
                <Image
                  ...
                  src={
                    images
                      ...
                      : `http://localhost:2000/asset/default.png`
                  }
                  style={{
                    height: "100%",
                    width: "100%",
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <Form.Group className="mb-3">
                                    ...
                                    <Form.Select
                                      ref="status_aktifadd"
                                      type="text"
                                      defaultValue={item.status_aktif}
                                      size="md"
                                      placeholder="Choose"
                                    >
                                      <option>Aktif</option>
                                ...
                                <td>
                                  <Button
                                    ...
                                    onClick={() =>
                                      this.onEditAddress(item.id_address)
                                    }
                                  >
                                    Save
                                  </Button>
                                  ...
                                  <Button
                                    variant="outline-danger"
                                    onClick={() =>
                                      this.onDeleteAddress(item.id_address)
                                    }
                                  >
                                    Delete
                                  </Button>
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                <Button
                                  ...
                                  onClick={() =>
                                    this.setState({ idEdit: item.id_address })
                                  }
                                >
                                  Edit
                                </Button>
